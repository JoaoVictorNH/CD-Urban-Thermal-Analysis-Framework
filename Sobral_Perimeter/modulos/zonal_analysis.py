...
def apply_building_change_mask_to_results(
    ...
    result = {
        ...
        'samples_change': {
            ...
            'index_t1':    np.array(index_t1_change),
            'index_t2':    np.array(index_t2_change),
            'lst_t1':      np.array(lst_t1_change),
            'lst_t2':      np.array(lst_t2_change),
        },
        'samples_no_change': {
            'delta_index': delta_index_no_change,
            'delta_lst':   delta_lst_no_change,
            'delta_uhi':   delta_uhi_no_change,
            'index_t1':    np.array(index_t1_no_change),
            'index_t2':    np.array(index_t2_no_change),
            'lst_t1':      np.array(lst_t1_no_change),
            'lst_t2':      np.array(lst_t2_no_change),
        },
        'correlations': {
            'index_lst': {
